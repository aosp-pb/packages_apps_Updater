...
import com.aospb.generatebp.GenerateBpPlugin
import com.aospb.generatebp.GenerateBpPluginExtension
import com.aospb.generatebp.models.Module
...
buildscript {
    ...
    dependencies {
        classpath("com.aospb:gradle-generatebp:+")
    }
}
...
android {
    ...
    defaultConfig {
        applicationId = "com.aospb.updater"
        minSdk = 30
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
