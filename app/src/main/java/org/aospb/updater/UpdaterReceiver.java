...
public class UpdaterReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_INSTALL_REBOOT =
            "org.aospb.updater.action.INSTALL_REBOOT";
    ...
    private static void showUpdateFailedNotification(Context context) {
        ...
        String buildInfo = context.getString(R.string.aospb_build_version_date, BuildInfoUtils.getBrand(),
                Utils.getDisplayVersion(BuildInfoUtils.getBuildVersion()), BuildInfoUtils.getBrand(), buildDate);
